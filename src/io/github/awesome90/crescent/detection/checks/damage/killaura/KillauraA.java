...
public class KillauraA extends CheckVersion {
	...
	private static final int ALLOWED_HITS_PER_SECOND = Crescent.getInstance().getConfig()
			.getInt("killaura.a.allowedHitsPerSecond");
	private static final int ATTACK_TIME_COUNT_INTERVAL = Crescent.getInstance().getConfig()
