package io.github.davidm98.crescent.info;
...
import io.github.davidm98.crescent.behaviour.Behaviour;
import io.github.davidm98.crescent.detection.CheckType;
import io.github.davidm98.crescent.detection.checks.Check;
import io.github.davidm98.crescent.detection.checks.blocks.liquids.Liquids;
import io.github.davidm98.crescent.detection.checks.damage.antidamage.AntiDamage;
import io.github.davidm98.crescent.detection.checks.damage.criticals.Criticals;
import io.github.davidm98.crescent.detection.checks.damage.killaura.Killaura;
import io.github.davidm98.crescent.detection.checks.damage.nofall.NoFall;
import io.github.davidm98.crescent.detection.checks.damage.reach.Reach;
import io.github.davidm98.crescent.detection.checks.health.fastheal.FastHeal;
import io.github.davidm98.crescent.detection.checks.interact.autoclicker.Autoclicker;
import io.github.davidm98.crescent.detection.checks.interact.fastbow.Fastbow;
import io.github.davidm98.crescent.detection.checks.interact.noswing.NoSwing;
import io.github.davidm98.crescent.detection.checks.inventory.inventorytweaks.InventoryTweaks;
import io.github.davidm98.crescent.detection.checks.movement.antigravity.AntiGravity;
import io.github.davidm98.crescent.detection.checks.movement.antivelocity.AntiVelocity;
import io.github.davidm98.crescent.detection.checks.movement.fly.Fly;
import io.github.davidm98.crescent.detection.checks.movement.impossible.Impossible;
import io.github.davidm98.crescent.detection.checks.movement.packets.Packets;
import io.github.davidm98.crescent.detection.checks.movement.speed.Speed;
import io.github.davidm98.crescent.detection.checks.movement.waterwalk.WaterWalk;
import io.github.davidm98.crescent.learn.KnownCheating;
